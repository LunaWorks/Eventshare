          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="namereg" id="usrname" placeholder="Írd be a felhasználóneved" required>
              </div>
                <div class="form-group">
                  <label for="usrname"><span class="glyphicon glyphicon-user"></span> Felhasználónév:</label>
                  <input type="text" class="form-control"  name="usernamereg" id="usrname" placeholder="Írd be a felhasználóneved" required>
                </div>
                <div class="form-group">
                  <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Jelszó:</label>
                  <input type="password" class="form-control" name="passwordreg" id="psw" placeholder="Írd be a jelszavadat" required>
                </div>
                <div class="form-group">
                  <label for="username"><span class="glyphicon glyphicon-eye-open" name="age" placeholder="írd be a korodat!"></span> Kor:</label>
                  <input type="text" class="form-control" name="agereg" placeholder="Írd be a korodat" required>
                </div>
